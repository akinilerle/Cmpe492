...
public class UserStoryParserTest {
    ...
    private UserStoryParser userStoryParser = new UserStoryParser();
    ...
    public void it_should_parse_format_1() throws Exception {
        ...
        assertEquals(userStory1.getType(),UserStory.Type.TYPE_RRB);
        ...
        assertEquals(userStory2.getBenefit(),"böylece gerçekleşecek etkinlikleri görmekten çok etkinliğimiz" +
                " için kiralayabileceğimiz uygun yerleri görmüş olacağız");
        assertEquals(userStory2.getType(),UserStory.Type.TYPE_RRB);
        ...
        assertEquals(userStory3.getType(),UserStory.Type.TYPE_RRB);
    }
    ...
    public void it_should_parse_format_2() throws Exception {
        ...
        assertEquals(userStory1.getType(),UserStory.Type.TYPE_RBR);
        ...
        assertEquals(userStory2.getType(),UserStory.Type.TYPE_RBR);
        ...
        assertEquals(userStory3.getType(),UserStory.Type.TYPE_RBR);
    }
    ...
    public void it_should_parse_format_3() throws Exception {
        ...
        assertEquals(userStory1.getType(),UserStory.Type.TYPE_RR);
        ...
        assertEquals(userStory2.getType(),UserStory.Type.TYPE_RR);
        ...
        assertEquals(userStory3.getType(),UserStory.Type.TYPE_RR);
    }
